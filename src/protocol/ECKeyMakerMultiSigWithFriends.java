...
public class ECKeyMakerMultiSigWithFriends {
	public static void main(String[] args) throws Exception
	{
		...
		for(int i = 0; i < k; i++)
		{
			...
			try {
				arg0 = new FileWriter("inputs/P1." + i + "_Keys" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]);
			} catch (IOException e) {
				e.printStackTrace();
			}
			p1Out[i] = new BufferedWriter(arg0);
			try {
				arg0 = new FileWriter("inputs/P2." + i + "_Keys" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]);
			} catch (IOException e) {
				e.printStackTrace();
			}
