...
public class ECKeyMakerMultiSig {
	public static void main(String[] args) throws Exception
	{
		...
		if(args.length >= 7 && args[6] != null && args[6] != "0" && args[6] != "")
		{
			...
			if(last <= numKeys)
			{
				Files.copy(new File("inputs/P1Keys" + args[6] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]).toPath(), new File("P1Keys" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]).toPath(), StandardCopyOption.REPLACE_EXISTING);
				Files.copy(new File("inputs/Account" + args[6] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]).toPath(), new File("Account" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]).toPath(), StandardCopyOption.REPLACE_EXISTING);
				Files.copy(new File("inputs/P2Keys" + args[6] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]).toPath(), new File("P2Keys" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]).toPath(), StandardCopyOption.REPLACE_EXISTING);
				Files.copy(new File("inputs/Keys" + args[6] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]).toPath(), new File("Keys" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]).toPath(), StandardCopyOption.REPLACE_EXISTING);
				start = last;
				try {
					arg0 = new FileWriter("inputs/Keys" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3], true);
				} catch (IOException e) {
				...
				try {
					arg0 = new FileWriter("inputs/Account" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3], true);
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				...
				try {
					arg0 = new FileWriter("inputs/P1Keys" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3], true);
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				...
				try {
					arg0 = new FileWriter("inputs/P2Keys" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3], true);
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}	
		...
		{
			try {
				arg0 = new FileWriter("inputs/Keys" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]);
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			try {
				arg0 = new FileWriter("inputs/Account" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]);
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			try {
				arg0 = new FileWriter("inputs/P1Keys" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]);
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			try {
				arg0 = new FileWriter("inputs/P2Keys" + args[1] + "_" + args[4] + "_" + args[5] + "_" + args[2] + "_" + args[3]);
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
