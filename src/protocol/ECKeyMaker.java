...
public class ECKeyMaker {
	public static void main(String[] args) throws Exception
	{
		...
		if(args.length >= 6 && args[5] != null && args[5] != "0" && args[5] != "")
		{
			...
			if(last <= numKeys)
			{
				Files.copy(new File("inputs/P1Keys" + args[5] + "_" + args[2] + "_" + args[3]).toPath(), new File("P1Keys" + args[2] + "_" + args[3] + "_" + args[4]).toPath(), StandardCopyOption.REPLACE_EXISTING);
				Files.copy(new File("inputs/Account" + args[5] + "_" + args[2] + "_" + args[3]).toPath(), new File("Account" + args[2] + "_" + args[3] + "_" + args[4]).toPath(), StandardCopyOption.REPLACE_EXISTING);
				Files.copy(new File("inputs/P2Keys" + args[5] + "_" + args[2] + "_" + args[3]).toPath(), new File("P2Keys" + args[2] + "_" + args[3] + "_" + args[4]).toPath(), StandardCopyOption.REPLACE_EXISTING);
				Files.copy(new File("inputs/Keys" + args[5] + "_" + args[2] + "_" + args[3]).toPath(), new File("Keys" + args[2] + "_" + args[3] + "_" + args[4]).toPath(), StandardCopyOption.REPLACE_EXISTING);
				start = last;
				try {
					arg0 = new FileWriter("inputs/Keys" + args[1] + "_" + args[2] + "_" + args[3], true);
				} catch (IOException e) {
				...
				try {
					arg0 = new FileWriter("inputs/Account" + args[1] + "_" + args[2] + "_" + args[3], true);
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				...
				try {
					arg0 = new FileWriter("inputs/P1Keys" + args[1] + "_" + args[2] + "_" + args[3], true);
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
				...
				try {
					arg0 = new FileWriter("inputs/P2Keys" + args[1] + "_" + args[2] + "_" + args[3], true);
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}	
		...
		{
			try {
				arg0 = new FileWriter("inputs/Keys" + args[1] + "_" + args[2] + "_" + args[3]);
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			try {
				arg0 = new FileWriter("inputs/Account" + args[1] + "_" + args[2] + "_" + args[3]);
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			try {
				arg0 = new FileWriter("inputs/P1Keys" + args[1] + "_" + args[2] + "_" + args[3]);
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			try {
				arg0 = new FileWriter("inputs/P2Keys" + args[1] + "_" + args[2] + "_" + args[3]);
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
